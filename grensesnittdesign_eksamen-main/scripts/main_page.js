...
let historyOnLoad = () => {
    ...
    <div id="historyHeaderDiv">
        ...
        <svg id="closeHistory" onclick="showHistory()" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgb(255, 132, 31)" width="50px" height="50px"><path d="M0 0h24v24H0z" fill="#dcdcdc"/><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
    </div>`;
...
let purchaseAndAddToHistory = () => {
    ...
    alert("Betaling godkjent! Ditt ordrenummer er: " + Math.floor(Math.random() * 50 + 1) + ". Vennligst vent til ditt nummer blir ropt opp.")
...
//Function to show shoppingcartlist after onclick
let clicked1 = false; 
let showShoppingList = () => {
    ...
    if(!clicked1){
        ...
        shoppingCartDiv.id = "shoppingCartContainerOpened";
        
        list.style.bottom = "25%";
        list.style.height = "75%";
        
        section.style.overflowY = "hidden";

        showCartButton.setAttribute("onclick", "purchaseAndAddToHistory()");
        showCartButton.innerHTML = "Betal";

        clicked1 = true;
    }else{
        shoppingCartDiv = document.getElementById("shoppingCartContainerOpened")
        shoppingCartDiv.id = "shoppingCartContainer";
        list.style.height = "0%";
        section.style.overflowY = "scroll";
        showCartButton.setAttribute("onclick", "showShoppingList()");
        showCartButton.innerHTML = "Vis Handlekurv";
        clicked1 = false;
    }
}
